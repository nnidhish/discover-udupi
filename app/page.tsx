...
const DiscoverUdupi = () => {
  ...
  const locations = [
    ...
    },
    {
      ...
      tips: "Try the special thali during lunch. Expect queues during peak hours. Must-try: Masala dosa and filter coffee.",
      hours: "7:00 AM - 10:00 PM",
      rating: 4.7,
      reviews: 3241,
      address: "Manipal Road, Udupi, Karnataka 576101",
      highlights: ["Authentic Cuisine", "Historic Legacy", "Famous Dosas"],
      bestTime: "Lunch time for full experience"
    },
    {
      id: 4,
      name: "Kudlu Falls",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-teal-500 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button className="border-2 border-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-purple-600 transition-all transform hover:scale-105">
              View on Map
            </button>
          </div>
        </div>
      ...
      <button className="fixed bottom-6 right-6 bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-110 z-40">
